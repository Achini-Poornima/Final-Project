...
public class UserModel {
    public boolean saveUser(UserDto userDto) throws SQLException, ClassNotFoundException {
        ...
        return SQLUtil.execute(sql, userDto.getUserId(), userDto.getUserName(), userDto.getPassword(), userDto.getRole());
    }
    ...
    public boolean updateUser(UserDto userDto) throws SQLException, ClassNotFoundException {
        ...
        return SQLUtil.execute(sql, userDto.getUserName(), userDto.getPassword(), userDto.getRole(), userDto.getUserId());
    }
