...
public class UserModel {
    public boolean saveUser(UserDto userDto) throws SQLException, ClassNotFoundException {
        ...
        return CrudUtil.execute(sql, userDto.getUserId(), userDto.getUserName(), userDto.getPassword(), userDto.getRole());
    }
    ...
    public boolean updateUser(UserDto userDto) throws SQLException, ClassNotFoundException {
        ...
        return CrudUtil.execute(sql, userDto.getUserName(), userDto.getPassword(), userDto.getRole(), userDto.getUserId());
    }
